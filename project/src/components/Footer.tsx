        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-bold">XYZ Travel</span>
            </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="/search" className="text-gray-300 hover:text-white transition-colors">Destinations</a></li>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-300">info@xyztravel.com</span>
              </div>
            </div>
          </div>
        </div>
